...
export function QuizModal({ isOpen, onClose }: QuizModalProps) {
  ...
  const handleShowResult = () => {
    ...
    // Save the recommendation to localStorage for the explore page to use
    localStorage.setItem('recommendedCourse', recommendation);
      ...
      <DialogContent className="sm:max-w-xl md:max-w-3xl lg:max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            Answer a few questions to discover which course aligns with your goals
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-6">
          {currentStep !== 'result' ? (
            <>
              <h3 className="text-xl font-bold mb-6">{currentQuizStep.question}</h3>
